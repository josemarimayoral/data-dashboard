...
if load_big:
    ...
    mentions = None
    replies  = None
    st.info("App started in light mode. To load Mentions and Replies, click the button on the sidebar.")
# --- fin parche ---
...
# 🔥 NUEVO: heatmap por hora y día de la semana
...
with tabs[0]:
    ...
    # 🔥 NUEVO: heatmap global de actividad
    all_df = pd.concat([posts, rts, replies, mentions, quotes], ignore_index=True)
